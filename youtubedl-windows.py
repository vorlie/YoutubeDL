...
image_1 = canvas.create_image(424.0,61.0,image=image_image_1)
canvas.create_text(325.0,35.0,anchor="nw",text="YoutubeDL",fill="#FFFFFF",font=("Montserrat Bold", 36 * -1))
image_image_2 = PhotoImage(file=relative_to_assets("image_2.png"))
image_2 = canvas.create_image(424.0,306.0,image=image_image_2)
image_image_4 = PhotoImage(file=relative_to_assets("image_4.png"))
image_4 = canvas.create_image(297.0,171.0,image=image_image_4)
image_image_5 = PhotoImage(file=relative_to_assets("image_5.png"))
image_5 = canvas.create_image(297.0,305.0,image=image_image_5)
image_image_7 = PhotoImage(file=relative_to_assets("image_7.png"))
image_7 = canvas.create_image(313.0,171.0,image=image_image_7)
entry_image_1 = PhotoImage(file=relative_to_assets("entry_1.png"))
entry_bg_1 = canvas.create_image(307.0,171.5,image=entry_image_1)
entry_1 = Entry(bd=0,bg="#5856D6",fg="#000716",highlightthickness=0)
entry_1.place(x=101.0,y=160.0,width=412.0,height=21.0)
image_image_8 = PhotoImage(file=relative_to_assets("image_8.png"))
image_8 = canvas.create_image(77.0,171.0,image=image_image_8)
button_image_1 = PhotoImage(file=relative_to_assets("button_1.png"))
button_1 = Button(image=button_image_1,borderwidth=0,highlightthickness=0,command=select_directory,relief="flat",cursor="hand2")
button_1.place(x=585.0,y=349.0,width=207.0,height=48.0)
image_image_10 = PhotoImage(file=relative_to_assets("image_10.png"))
image_10 = canvas.create_image(689.0,372.0,image=image_image_10)
...
button_2 = Button(image=button_image_2,borderwidth=0,highlightthickness=0,command=start_audio_download,relief="flat",cursor="hand2")
button_2.place(x=586.0,y=282.0,width=204.0,height=48.0)
image_image_11 = PhotoImage(file=relative_to_assets("image_11.png"))
image_11 = canvas.create_image(689.0,305.0,image=image_image_11)
...
button_3 = Button(image=button_image_3,borderwidth=0,highlightthickness=0,command=start_video_download,relief="flat",cursor="hand2")    
button_3.place(x=586.0,y=214.0,width=204.0,height=48.0)
image_image_12 = PhotoImage(file=relative_to_assets("image_12.png"))
image_12 = canvas.create_image(689.0,238.0,image=image_image_12)
image_image_13 = PhotoImage(file=relative_to_assets("image_13.png"))
image_13 = canvas.create_image(689.0,171.0,image=image_image_13)
...
button_5 = Button(image=button_image_5,borderwidth=0,highlightthickness=0,command=start_fetching_info,relief="flat",cursor="hand2")
button_5.place(x=586.0,y=148.0,width=204.0,height=48.0)
image_image_14 = PhotoImage(file=relative_to_assets("image_14.png"))
image_14 = canvas.create_image(78.0,62.0,image=image_image_14)
...
image_15 = canvas.create_image(425.0,439.0,image=image_image_15)
